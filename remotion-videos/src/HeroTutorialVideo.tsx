...
/* ------------------------------------------------------------------ */
/*  SCENE 1: "Raccontaci la tua attività" - Chat message (0-4s)       */
/* ------------------------------------------------------------------ */
const Scene1_ContactUs: React.FC = () => {
  ...
  const messages = [
    { text: "Ho un ristorante a Roma, cucina tradizionale", delay: bubble1Enter },
    { text: "Vorrei un sito moderno con prenotazioni online", delay: bubble2Enter },
    { text: "Il mio logo e' rosso e oro", delay: bubble3Enter },
  ];
...
/* ------------------------------------------------------------------ */
/*  SCENE 2: "Il nostro team lavora per te" - Design process (4-8s)   */
/* ------------------------------------------------------------------ */
const Scene2_WeWork: React.FC = () => {
  ...
  const steps = [
    ...
    { label: "Testi", icon: "✍️", progress: el2 },
    { label: "Foto", icon: "📸", progress: el3 },
    { label: "Animazioni", icon: "✨", progress: el4 },
  ];
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily: FONT, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      <div style={{
        ...
        2. Il nostro team lavora per te
      </div>
      <div style={{
        opacity: interpolate(titleEnter, [0, 1], [0, 1]),
        fontSize: 24, color: COLORS.muted, marginBottom: 60, textAlign: "center",
      }}>
        Creiamo il sito su misura. Tu non devi fare nulla.
      </div>
...
/* ------------------------------------------------------------------ */
/*  SCENE 3: "Ecco il tuo sito!" - Browser reveal (8-12.5s)          */
/* ------------------------------------------------------------------ */
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily: FONT, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 20, fontWeight: 700, color: COLORS.green }}>Pronto in 48h</span>
      </div>
    </AbsoluteFill>
  );
};
...
/* ------------------------------------------------------------------ */
/*  SCENE 4: "Ti piace? Paghi." Decision (12.5-16s)                  */
/* ------------------------------------------------------------------ */
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, fontFamily: FONT, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{
        ...
        Vedi il risultato prima di spendere un centesimo.
      </div>
      ...
      <div style={{ display: "flex", gap: 40 }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 28, fontWeight: 800, color: COLORS.green }}>Ti piace?</span>
          <span style={{ fontSize: 20, color: COLORS.muted, textAlign: "center" }}>Lo mettiamo online.</span>
        </div>

        {/* Blue card - Non ti piace */}
        <div style={{
          ...
          <span style={{ fontSize: 28, fontWeight: 800, color: COLORS.accent }}>Non ti piace?</span>
          <span style={{ fontSize: 20, color: COLORS.muted, textAlign: "center" }}>Non paghi nulla. Zero.</span>
        </div>
      </div>
      ...
      <div style={{
        ...
        Zero rischi. Zero obblighi. Sempre.
      </div>
    </AbsoluteFill>
  );
};
...
/* ------------------------------------------------------------------ */
/*  Fade wrapper: fades in at start and out at end of its duration    */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  MAIN COMPOSITION: 18 seconds, 540 frames at 30fps, LOOPABLE      */
/* ------------------------------------------------------------------ */
export const HeroTutorialVideoComposition: React.FC = () => {
  // Scene durations at 30fps:
  // Scene 1: 120 frames (4s) — Contact us
  // Scene 2: 120 frames (4s) — We work
  // Scene 3: 135 frames (4.5s) — Site ready
  // Scene 4: 120 frames (4s) — Decision
  // Fade out: 45 frames (1.5s) — Loop fade
  const S1 = 120;
  const S2 = 120;
  const S3 = 135;
  const S4 = 120;
...
export const HERO_TUTORIAL_VIDEO_CONFIG = {
