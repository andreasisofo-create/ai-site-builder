    ...
    styles: [
      {
        ...
        primaryColor: "#1a1a2e",
        secondaryColor: "#e17055",
        sections: ["hero", "about", "services", "blog", "gallery", "contact", "footer"],
      },
      {
        id: "blog-dark",
        label: "Dark Magazine",
    ...
    styles: [
      {
        ...
        sections: ["hero", "about", "services", "schedule", "team", "cta", "contact", "footer"],
      },
      {
        id: "event-minimal",
        ...
        primaryColor: "#3B82F6",
        secondaryColor: "#dfe6e9",
        sections: ["hero", "about", "services", "schedule", "team", "contact", "footer"],
      },
    ],
  },
  {
...
export const SECTION_LABELS: Record<string, string> = {
  ...
  listings: "Annunci / Schede",
  donations: "Donazioni / Fundraising",
  comparison: "Confronto / Tabella",
  booking: "Prenotazione / Form",
  "app-download": "Download App",
  "social-proof": "Social Proof / Numeri",
...
export const ALL_SECTIONS = [
  ...
  { id: "features", label: "Funzionalit\u00E0", default: false },
  { id: "cta", label: "Call to Action", default: false },
  { id: "pricing", label: "Prezzi / Piani", default: false },
  { id: "blog", label: "Blog / Articoli", default: false },
  { id: "booking", label: "Prenotazione", default: false },
  { id: "schedule", label: "Programma / Orari", default: false },
  { id: "comparison", label: "Confronto / Tabella", default: false },
  { id: "social-proof", label: "Social Proof", default: false },
...
export const ALL_SECTIONS_EN = [
  ...
  { id: "features", label: "Features", default: false },
  { id: "cta", label: "Call to Action", default: false },
  { id: "pricing", label: "Pricing / Plans", default: false },
  { id: "blog", label: "Blog / Articles", default: false },
  { id: "booking", label: "Booking", default: false },
  { id: "schedule", label: "Schedule / Timetable", default: false },
  { id: "comparison", label: "Comparison / Table", default: false },
  { id: "social-proof", label: "Social Proof", default: false },
