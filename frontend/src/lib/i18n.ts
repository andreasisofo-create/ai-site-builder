...
export const translations = {
  ...
  en: {
    ...
    hero: {
      badge: "AI-Powered Website Builder + Ads Management",
      titleLine1: "Build stunning sites.",
      titleLine2: "Drive real clients.",
      titleLine3: "Scale your business.",
      description:
        "The only platform that builds your website in 60 seconds AND fills your pipeline with expert-managed Meta and Google Ads campaigns.",
      ctaPrimary: "Build Your Site",
      ctaSecondary: "Explore Ads Service",
      trustNoCode: "Zero coding required",
      trustSetup: "Live in 60 seconds",
    ...
    quickStats: {
      creationTime: "60s",
      creationTimeLabel: "Avg. build time",
      templates: "19",
      templatesLabel: "Pro templates",
      animations: "29",
      animationsLabel: "Motion effects",
      monitoring: "24/7",
      monitoringLabel: "Campaign monitoring",
    },
    howItWorks: {
      title: "Go live",
      titleHighlight: " in 4 simple steps",
      subtitle: "No technical skills needed. Describe, generate, customize, publish.",
      steps: [
        {
          title: "Describe",
          description: "Tell us about your business, your services, and the look you want.",
        },
        {
          title: "Generate",
          description: "Our AI builds your complete website in under 60 seconds.",
        },
        {
          title: "Customize",
          description: "Refine colors, copy, and images with the AI chat editor.",
        },
        {
          title: "Publish",
          description: "Go live with one click. Custom domain and SSL included.",
        },
      ],
    },
    features: {
      ...
      subtitle:
        "No designers. No developers. Our AI delivers professional websites that look handcrafted by a top-tier agency.",
      items: [
        {
          title: "Generative AI Engine",
          description:
            "Describe your business, get a polished website in 60 seconds. AI handles layout, copywriting, and design — tailored to your brand.",
        },
        {
          title: "19 Pro Templates",
          description:
            "8 categories, 19 distinct styles: restaurants, SaaS, portfolios, e-commerce, corporate, blogs, and events.",
        },
        {
          title: "AI Chat Editor",
          description:
            "Refine your site by chatting with AI. Update colors, copy, and layout using plain language.",
        },
        {
          title: "GSAP Animations",
          description:
            "29 cinematic effects: scroll reveals, parallax, text-split, magnetic buttons, and more.",
        },
        {
          title: "Mobile First",
          description:
            "Pixel-perfect on every device — mobile, tablet, and desktop from day one.",
        },
        {
          title: "1-Click Publish",
          description:
            "Hosting, SSL, and subdomain included out of the box. Connect your own domain anytime.",
        },
        {
          title: "Semantic HTML5",
          description:
            "Clean, accessible code built for search engines. Designed to rank on Google.",
        },
        {
          title: "Full-Page Design",
          description:
            "Hero, about, services, contact, footer — every section included, every element customizable.",
        },
      ],
    },
    ads: {
      badge: "Ads Management Service",
      title: "A website alone won't cut it.",
      titleHighlight: "You need clients.",
      subtitle:
        "Our team runs your Meta and Google Ads campaigns, powered by AI and backed by human expertise.",
      columns: [
        {
          title: "Meta Ads",
          subtitle: "Instagram + Facebook",
        ...
        },
        {
          ...
          items: [
            ...
            "Full policy compliance guaranteed",
        ...
        },
        {
          ...
          items: [
            "AI-generated video with Higgsfield",
            "Ad creatives and social graphics",
      ...
      flowStep1Title: "AI handles the setup",
      flowStep1Sub: "Creatives, copy, targeting",
      flowStep2Title: "Experts review and approve",
      flowStep2Sub: "Human oversight guaranteed",
      flowStep3Title: "Launch + 24/7 monitoring",
      flowStep3Sub: "Continuous optimization",
      complianceBadge: "100% Google policy compliant \u2014 human oversight guaranteed",
    },
    timeline: {
      title: "Your roadmap to",
      titleHighlight: " sustainable growth",
      subtitle: "From zero to predictable revenue in just a few weeks.",
      milestones: [
        { time: "Week 1", title: "AI builds your site" },
        { time: "Week 2", title: "Ad campaigns go live" },
        { time: "Week 4", title: "First results roll in" },
        { time: "Month 3", title: "Predictable growth" },
      ],
    },
    earnings: {
      badge: "ROI Calculator",
      title: "See your potential",
      titleHighlight: " return",
      subtitle: "Estimate the revenue your Ads investment could generate.",
      budgetLabel: "Monthly Ads budget",
      businessTypeLabel: "Business type",
      businessTypes: {
        ristorante: "Restaurant",
        studio: "Professional Practice",
        ecommerce: "E-commerce",
        servizi: "Services",
      },
    ...
    comparison: {
      ...
      diy: {
        ...
        items: [
          ...
          "Ongoing management falls on you",
        ],
    ...
    stats: {
      sitesGenerated: "Websites launched",
      activeCampaigns: "Active ad campaigns",
      revenueGenerated: "Revenue driven for clients",
      clientRating: "Average client rating",
    },
    pricing: {
      title: "Transparent pricing,",
      titleHighlight: " zero hidden fees",
      subtitle: "Start with your site. Add Ads when you're ready to scale.",
      ...
      plans: [
        {
          ...
          price: "199",
          period: "one-time",
          description: "Your AI website, live in seconds",
          features: [
            "AI-generated website (1 page)",
            "Subdomain hosting",
            "SSL certificate included",
            "3 AI chat refinements",
          ],
          adsFeatures: [],
          cta: "Get Started",
        },
        {
          ...
          price: "49",
          period: "/month",
          description: "Complete site + client acquisition",
          features: [
            "Full multi-page website",
            "Custom domain",
            "Unlimited AI chat edits",
        ...
        },
        {
          ...
          price: "99",
          period: "/month",
          description: "Accelerated growth, AI-powered",
          features: [
        ...
        },
        {
          ...
          price: "199",
          period: "/month",
          description: "Full-service, dedicated strategy",
          features: [
    ...
    testimonials: {
      title: "Trusted by 2,800+ businesses",
      subtitle: "Companies across Italy already rely on E-quipe to grow their online presence.",
      items: [
        {
          quote:
            "Built my site in 10 minutes. With the Ads campaigns, I doubled my bookings within 3 months.",
          author: "Marco Rossi",
          role: "Ristorante Da Mario",
        },
        {
          quote:
            "Site live in an hour, campaigns running the next day. 15 new clients every month.",
          author: "Laura Bianchi",
          role: "Law Firm",
        },
        {
          quote:
            "The AI nailed my brand style. Google Ads now delivers 15 qualified leads per week.",
          author: "Giuseppe Verdi",
          role: "Photographer",
        },
      ],
      ...
      items: [
        {
          ...
          a: "Pick a template from our gallery of 19 professional styles, describe your business in 3 simple steps, and AI generates your complete website in under 60 seconds. Then fine-tune it with the AI chat editor.",
        },
        {
          q: "What does it cost?",
          a: "The Starter plan begins at \u20AC199 one-time for the website alone. For Ads management, plans start at \u20AC49/month (Business) with Meta campaigns included. You can always start with just the site and add Ads later.",
        },
        {
          q: "Who manages my Ads campaigns?",
          a: "Campaigns are drafted by our AI, then reviewed and approved by E-quipe's in-house experts. Every campaign includes guaranteed human oversight and continuous monitoring.",
        },
        {
          q: "Can I use my own domain?",
          a: "Absolutely. From the Business plan onward, you can connect your custom domain. The Starter plan includes a free subdomain (yourname.e-quipe.app).",
        },
        {
          q: "What does 24/7 monitoring include?",
          a: "Our system tracks your campaign performance in real time. Underperforming ads are automatically optimized or replaced. You receive regular reports with clear, actionable metrics.",
        },
        {
          q: "Can I start with just the site and add Ads later?",
          a: "Yes. Start with the Starter plan (site only) and upgrade to Business or Growth whenever you're ready to activate Ads management.",
        },
        {
          q: "What quality are the generated sites?",
          a: "Semantic HTML5, Tailwind CSS, professional GSAP animations, fully responsive, and SEO-optimized. Clean, production-grade code that search engines love.",
        },
        {
          q: "How soon will I see Ads results?",
          a: "Expect initial results within 2\u20134 weeks and stable, predictable growth by month 2\u20133. Every campaign is continuously refined by AI with expert human oversight.",
        },
      ],
    },
    cta: {
      title: "Ready to grow your business?",
      description: "Website + Ads: the complete growth stack for your business.",
    ...
    footer: {
      brandDescription:
        "E-quipe S.r.l.s \u2014 The AI platform that builds your website and manages your ad campaigns to drive real business growth.",
