...
export const translations = {
  it: {
    ...
    pricing: {
      ...
      subtitle: "Crea il sito con l'AI, aggiungi le campagne quando vuoi crescere.",
      ...
      plans: [
        {
          ...
          price: "0",
          period: "gratis",
          description: "Crea e prova il sito senza pagare",
          features: [
            "Generazione sito AI completa",
            "Anteprima desktop e mobile",
            "5 modifiche di prova",
        ...
        },
        {
          ...
          price: "19,90",
          period: "/mese",
          description: "Il tuo sito AI online",
          features: [
            "Fino a 5 pagine AI",
            "Sottodominio .e-quipe.app",
            "Hosting + SSL incluso",
            "50 modifiche AI/mese",
            "SEO base",
          ],
          cta: "Scegli Starter",
          popular: false,
        },
        {
          ...
          price: "39",
          period: "/mese",
          description: "Sito completo con dominio tuo",
          features: [
            "Fino a 15 pagine AI",
            "Dominio .it/.com incluso",
            "200 modifiche AI/mese",
            "SEO avanzato + Schema + Sitemap",
            "Dashboard traffico + Report",
        ...
        },
        {
          ...
          price: "199",
          period: "/mese",
          description: "Campagne Meta e Google gestite",
          features: [
            "Meta Ads da \u20AC199/mese",
            "Google Ads da \u20AC249/mese",
            "Combo da \u20AC379/mese",
            "AI illimitata + DM automatici",
            "Report + Dashboard live",
          ],
          cta: "Scopri Pack Ads",
          popular: false,
        },
    ...
    heroAgency: {
      ...
      description: "Un sito professionale su misura, progettato per farvi trovare sia su Google che dalle intelligenze artificiali.",
      descriptionLine2: "Con i vostri lavori in vetrina, design moderno, perfetto da cellulare.",
      cta: "Contattaci — e' gratis",
      ctaSecondary: "Oppure crealo da solo in 60 secondi",
      trustBadges: [
        "Ottimizzato per Google + AI",
    ...
    featuresAgency: {
      ...
      items: [
        { title: "Trovabile su Google E dalle AI", description: "Il tuo sito e' ottimizzato per i motori di ricerca e strutturato per essere citato dalle intelligenze artificiali." },
        { title: "Assistente vocale AI", description: "Un chatbot addestrato sulla tua azienda, installato sul tuo sito. Risponde ai clienti 24 ore su 24, a voce." },
        { title: "I tuoi lavori in vetrina", description: "Portfolio fotografico dei tuoi progetti migliori. I clienti vedono subito la qualita' del tuo lavoro." },
        { title: "Perfetto da cellulare", description: "Il sito si adatta automaticamente a telefono, tablet e computer." },
        { title: "Design moderno su misura", description: "Non un template generico: un sito creato apposta per la tua attivita', con il tuo stile." },
        { title: "Testi scritti dall'AI", description: "Copy professionali generati dall'intelligenza artificiale, calibrati sulla tua attivita'." },
      ],
      cta: "Contattaci — e' gratis",
    },
    aiBuilder: {
    ...
    faqAgency: {
      title: "Domande Frequenti",
      items: [
        { q: "E' davvero gratis?", a: "Si', la creazione del sito e' completamente gratuita. Lo facciamo noi, te lo mostriamo, e paghi solo se ti convince. Se non ti piace, amici come prima." },
        { q: "Cosa vuol dire 'ottimizzato per le AI'?", a: "Significa che il tuo sito e' strutturato con dati e contenuti che ChatGPT, Perplexity e Gemini possono leggere e citare. Quando qualcuno chiede 'miglior [attivita'] a [citta']', il tuo sito ha le carte per comparire." },
        { q: "Come funziona l'assistente vocale?", a: "E' un chatbot installato direttamente sul tuo sito, addestrato con le informazioni della tua azienda. Risponde ai visitatori a voce, 24 ore su 24, anche quando tu non ci sei." },
        { q: "Ho gia' un sito, posso rifarlo?", a: "Certo, non cambia nulla. Rifacciamo il sito da zero con tecnologia moderna e te lo mostriamo. Se ti piace, sostituisce il vecchio." },
        { q: "Quanto tempo ci vuole?", a: "Il nostro team, con l'aiuto dell'AI, ti presenta una bozza completa in 24-48 ore dalla richiesta." },
      ],
    },
    finalCta: {
      title: "Vuole vederlo in azione?",
      subtitle: "Vada su e-quipe.it e provi a parlare con il nostro assistente virtuale. Risponde a voce, 24 ore su 24.",
      cta: "Prova l'assistente su e-quipe.it",
      ctaSecondary: "Scrivici su WhatsApp al 389 909 4183",
    },
    aiRevolution: {
      ...
      cards: [
        ...
        { name: "Perplexity", description: "Ricerca con AI" },
        { name: "Gemini", description: "Integrato in Google" },
      ],
    },
    voiceAssistant: {
      badge: "Incluso: 1 Mese Gratis",
      title: "Un assistente virtuale che risponde 24/7",
      description: "Un chatbot vocale installato sul vostro sito, addestrato sulla vostra azienda. Un cliente entra alle 22, vuole sapere se fate un certo servizio nella sua zona?",
      punchline: "L'assistente risponde subito, a voce.",
      cta: "Provalo su e-quipe.it",
      ctaSecondary: "Scrivici su WhatsApp",
      chatMessages: [
        { role: "user", text: "Fate consegne a domicilio nella zona di Roma Nord?" },
        { role: "assistant", text: "Si'! Copriamo tutta Roma Nord, inclusi Parioli, Fleming e Vigna Clara. Le consegne sono gratuite sopra i 30\u20AC. Vuole ordinare?" },
      ],
    },
    page: {
    ...
    store: {
      ...
      subtitle: "Scegli il pacchetto perfetto per il tuo business",
      all: "Tutti",
      packs: "Pacchetti",
      website: "Sito Web",
      ads: "Ads",
      content: "Contenuti",
      hostingDomain: "Hosting & Domini",
      setup: "Setup",
      monthly: "/mese",
      oneTime: "Una tantum",
      included: "Incluso",
      ...
      active: "Attivo",
      recommended: "CONSIGLIATO",
      freeSetup: "SETUP GRATUITO",
      showMore: "Mostra tutto",
      exploreServices: "Esplora i nostri servizi",
    },
    checkout: {
      title: "Riepilogo Ordine",
      setupFee: "Setup (una tantum)",
      monthlyFee: "Canone mensile",
      firstPayment: "Primo pagamento",
      thenMonthly: "poi {price}/mese",
      immediateActivation: "Attivazione immediata",
      features: "Cosa include",
      proceed: "Procedi al pagamento",
      back: "Torna ai prezzi",
      processing: "Elaborazione in corso...",
      securePayment: "Pagamento sicuro via Revolut",
      serviceNotFound: "Servizio non trovato",
      serviceNotFoundDesc: "Il servizio richiesto non esiste o non e' piu' disponibile.",
      loadingError: "Errore nel caricamento dei servizi. Riprova.",
    ...
    adsPage: {
      ...
      pricing: {
        title: "Pack Ads. Prezzi trasparenti.",
        subtitle: "Fee fisso + percentuale sul budget. L'AI lavora senza limiti su ogni livello.",
        packs: [
          { name: "Meta Base", price: "\u20AC199", setup: "\u20AC299 setup", subscription: "/mese + 15% budget", desc: "Instagram & Facebook. Controllo 2x/settimana, report mensile.", features: ["Campagne illimitate Instagram & Facebook", "Contenuti AI illimitati", "A/B testing + DM automatici", "Tracking Pixel + CAPI", "Report mensile"], cta: "Scegli Meta Base" },
          { name: "Google Pro", price: "\u20AC399", setup: "\u20AC199 setup", subscription: "/mese + 12% budget", desc: "Ricerca, Display & Maps. Quality Score ottimizzato.", features: ["Campagne Ricerca + Display + Maps + Shopping", "Landing page AI illimitate", "Controllo giornaliero", "Quality Score ottimizzato", "Dashboard live + Report quindicinale", "Supporto chat 24h"], cta: "Scegli Google Pro", tag: "CONSIGLIATO" },
          { name: "Combo Pro", price: "\u20AC639", setup: "\u20AC249 setup", subscription: "/mese + 11% budget", desc: "Meta + Google insieme. Risparmi \u20AC109/mese.", features: ["Tutto di Meta Pro + Google Pro", "Retargeting cross-platform", "Attribution multi-touch", "Report unificato quindicinale", "Call strategica trimestrale", "Percentuale ridotta: 11%"], cta: "Scegli Combo Pro" },
          { name: "Combo Elite", price: "\u20AC999", setup: "Setup incluso (min. 6 mesi)", subscription: "/mese + 9% budget", desc: "Account manager dedicato. La % piu' bassa.", features: ["Tutto di Meta Elite + Google Elite", "Account manager dedicato", "Ottimizzazione quotidiana", "Report settimanale + Call mensile", "Percentuale piu' bassa: 9%"], cta: "Scegli Combo Elite" },
        ],
        notes: ["Prezzi IVA esclusa", "Budget pubblicitario escluso", "Sconto 15% pagamento annuale"],
      },
      testimonials: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Posso scegliere solo il servizio Ads senza il sito?", a: "Si', il servizio Ads e' completamente separato. Meta Ads parte da \u20AC199/mese + 15% del budget, Google Ads da \u20AC249/mese + 15%. Se aggiungi un sito AI Builder, risparmi il 15% sul canone del sito." },
  ...
  en: {
    ...
    pricing: {
      ...
      subtitle: "Create your site with AI, add campaigns when you want to grow.",
      ...
      plans: [
        {
          ...
          price: "0",
          period: "free",
          description: "Create and try without paying",
          features: [
        ...
        },
        {
          ...
          price: "19.90",
          period: "/month",
          description: "Your AI site, online",
          features: [
            "Up to 5 AI pages",
            ".e-quipe.app subdomain",
        ...
        },
        {
          ...
          price: "39",
          period: "/month",
          description: "Full site with your domain",
          features: [
            "Up to 15 AI pages",
            "Custom .it/.com domain included",
            "200 AI edits/month",
            "Advanced SEO + Schema + Sitemap",
            "Traffic dashboard + Reports",
        ...
        },
        {
          ...
          price: "199",
          period: "/month",
          description: "Managed Meta & Google campaigns",
          features: [
            "Meta Ads from \u20AC199/month",
            "Google Ads from \u20AC249/month",
            "Combo from \u20AC379/month",
            "Unlimited AI + Auto DMs",
    ...
    heroAgency: {
      ...
      description: "A professional custom website, designed to get you found on Google and by artificial intelligences.",
      descriptionLine2: "With your best work on display, modern design, perfect on mobile.",
    ...
    featuresAgency: {
      ...
      items: [
        { title: "Found on Google AND by AI", description: "Your site is optimized for search engines and structured to be cited by artificial intelligences." },
        { title: "AI voice assistant", description: "A chatbot trained on your business, installed on your site. Answers customers 24/7, by voice." },
        { title: "Your work on display", description: "Photo portfolio of your best projects. Customers see your quality immediately." },
        { title: "Perfect on mobile", description: "The site adapts automatically to phone, tablet and computer." },
        { title: "Custom modern design", description: "Not a generic template: a site created specifically for your business, with your style." },
        { title: "AI-written copy", description: "Professional copy generated by artificial intelligence, calibrated for your business." },
      ],
      cta: "Contact us — it's free",
    },
    aiBuilder: {
    ...
    faqAgency: {
      title: "Frequently Asked Questions",
      items: [
        { q: "Is it really free?", a: "Yes, website creation is completely free. We build it, show it to you, and you only pay if you're convinced. If you don't like it, no hard feelings." },
        { q: "What does 'optimized for AI' mean?", a: "It means your site is structured with data and content that ChatGPT, Perplexity and Gemini can read and cite. When someone asks 'best [business] in [city]', your site has what it takes to appear." },
        { q: "How does the voice assistant work?", a: "It's a chatbot installed directly on your site, trained with your business information. It answers visitors by voice, 24/7, even when you're not there." },
        { q: "I already have a site, can I redo it?", a: "Of course, nothing changes. We rebuild from scratch with modern technology and show it to you. If you like it, it replaces the old one." },
        { q: "How long does it take?", a: "Our team, with AI assistance, presents you with a complete draft within 24-48 hours of your request." },
      ],
    },
    finalCta: {
      title: "Want to see it in action?",
      subtitle: "Visit e-quipe.it and try talking to our virtual assistant. It answers by voice, 24/7.",
      cta: "Try the assistant on e-quipe.it",
      ctaSecondary: "Write us on WhatsApp at 389 909 4183",
    },
    aiRevolution: {
      ...
      cards: [
        ...
        { name: "Perplexity", description: "AI-powered search" },
        { name: "Gemini", description: "Built into Google" },
      ],
    },
    voiceAssistant: {
      badge: "Included: 1 Month Free",
      title: "A virtual assistant that answers 24/7",
      description: "A voice chatbot installed on your site, trained on your business. A customer visits at 10 PM, wants to know if you offer a certain service in their area?",
      punchline: "The assistant answers immediately, by voice.",
      cta: "Try it on e-quipe.it",
      ctaSecondary: "Write us on WhatsApp",
      chatMessages: [
        { role: "user", text: "Do you deliver to North Rome?" },
        { role: "assistant", text: "Yes! We cover all of North Rome, including Parioli, Fleming and Vigna Clara. Deliveries are free over \u20AC30. Would you like to order?" },
      ],
    },
    page: {
    ...
    store: {
      ...
      subtitle: "Choose the perfect package for your business",
      all: "All",
      packs: "Packs",
      website: "Website",
      ads: "Ads",
      content: "Content",
      hostingDomain: "Hosting & Domains",
      setup: "Setup",
      monthly: "/month",
      oneTime: "One-time",
      included: "Included",
    ...
    checkout: {
      title: "Order Summary",
      setupFee: "Setup (one-time)",
      monthlyFee: "Monthly fee",
      firstPayment: "First payment",
      thenMonthly: "then {price}/month",
      immediateActivation: "Immediate activation",
      features: "What's included",
      proceed: "Proceed to payment",
      back: "Back to pricing",
      processing: "Processing...",
      securePayment: "Secure payment via Revolut",
      serviceNotFound: "Service not found",
      serviceNotFoundDesc: "The requested service does not exist or is no longer available.",
      loadingError: "Error loading services. Please try again.",
    ...
    adsPage: {
      ...
      pricing: {
        title: "Ads Packs. Transparent pricing.",
        subtitle: "Fixed fee + percentage of ad budget. AI works unlimited on every level.",
        packs: [
          { name: "Meta Base", price: "\u20AC199", setup: "\u20AC299 setup", subscription: "/month + 15% budget", desc: "Instagram & Facebook. Check 2x/week, monthly report.", features: ["Unlimited Instagram & Facebook campaigns", "Unlimited AI content", "A/B testing + Auto DMs", "Pixel + CAPI tracking", "Monthly report"], cta: "Choose Meta Base" },
          { name: "Google Pro", price: "\u20AC399", setup: "\u20AC199 setup", subscription: "/month + 12% budget", desc: "Search, Display & Maps. Optimized Quality Score.", features: ["Search + Display + Maps + Shopping campaigns", "Unlimited AI landing pages", "Daily monitoring", "Optimized Quality Score", "Live dashboard + Biweekly report", "Priority chat support 24h"], cta: "Choose Google Pro", tag: "RECOMMENDED" },
          { name: "Combo Pro", price: "\u20AC639", setup: "\u20AC249 setup", subscription: "/month + 11% budget", desc: "Meta + Google together. Save \u20AC109/month.", features: ["Everything in Meta Pro + Google Pro", "Cross-platform retargeting", "Multi-touch attribution", "Unified biweekly report", "Quarterly strategy call", "Reduced percentage: 11%"], cta: "Choose Combo Pro" },
          { name: "Combo Elite", price: "\u20AC999", setup: "Setup included (min. 6 months)", subscription: "/month + 9% budget", desc: "Dedicated account manager. Lowest percentage.", features: ["Everything in Meta Elite + Google Elite", "Dedicated account manager", "Daily optimization", "Weekly report + Monthly call", "Lowest percentage: 9%"], cta: "Choose Combo Elite" },
        ],
        notes: ["Prices excl. VAT", "Ad budget excluded", "15% discount for annual payment"],
      },
      testimonials: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: "Can I choose only the Ads service without a site?", a: "Yes, the Ads service is completely separate. Meta Ads starts at \u20AC199/month + 15% of budget, Google Ads from \u20AC249/month + 15%. Add an AI Builder site and save 15% on the site fee." },
